...
// Change Here
const TABS = [
  { id: "Inbox", title: "Inbox", icon: Inbox, color: "text-blue-600", shineColor: "bg-blue-400/30" },
  { id: "Planner", title: "Planner", icon: Calendar, color: "text-rose-500", shineColor: "bg-rose-400/30" },
  { id: "Alerts", title: "Alerts", icon: Alert, color: "text-red-500", shineColor: "bg-red-400/30" },
];
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "flex items-center font-mono uppercase gap-1.5 bg-white outline outline-2 outline-gray-100 overflow-hidden shadow-md transition-colors duration-75 ease-out p-3 cursor-pointer relative",
          isActive ? color : "text-gray-900",
          isActive ? "px-4" : "px-3"
        )}
        style={{
          borderRadius: "25px",
        ...
        <AnimatePresence>
          {showShine && (
            <motion.div
              ...
              className={cn("absolute inset-y-0 w-1/2 blur-md z-0", shineColor)}
            />
          )}
        </AnimatePresence>
